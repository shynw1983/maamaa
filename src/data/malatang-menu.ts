...
export const noodleReplacementOptions: MenuChoice[] = [
  { id: "replace-extra-wide-harusame", name: "板春雨50g追加", displayNames: {"zh":"加宽粉","ko":"넓적당면 추가","en":"Extra Wide Sweet Potato Noodles"}, price: 170 },
  { id: "replace-corn-noodle", name: "【お一人様1回限り】トウモロコシ麺50gに変更", displayNames: {"zh":"更换为玉米面","ko":"옥수수면으로 변경","en":"Change to Corn Noodles"}, price: 0 },
  { id: "replace-harusame", name: "春雨50gに変更", displayNames: {"zh":"更换为粉丝","ko":"당면으로 변경","en":"Change to Glass Noodles"}, price: 140 },
  { id: "replace-sweet-potato-noodle", name: "さつまいも麺50gに変更", displayNames: {"zh":"更换为红薯粉","ko":"고구마당면으로 변경","en":"Change to Sweet Potato Noodles"}, price: 140 },
  { id: "replace-round-yam-sheet", name: "【数量限定】山芋粉皮（丸）50gに変更", displayNames: {"zh":"更换为圆形山药粉皮","ko":"둥근 참마 당면으로 변경","en":"Change to Round Chinese Yam Starch Sheets"}, price: 140 },
  { id: "replace-rice-noodle", name: "ビーフン50gに変更", displayNames: {"zh":"更换为米粉","ko":"쌀국수로 변경","en":"Change to Rice Noodles"}, price: 140 },
...
export const heatLevels: MenuChoice[] = [
  ...
  { id: "oni", name: "鬼の一歩手前🔥🔥🔥🔥🔥", displayNames: {"zh":"鬼门关前","ko":"귀신 직전","en":"One Step from He ll"}, price: 200 },
...
export const menuSections: MenuSection[] = [
  {
    ...
    perOptionMax: 2,
    items: [
      { id: "wide-harusame", name: "【おすすめ❗️】もちもち板春雨50g", displayNames: {"zh":"宽粉","ko":"넓적당면","en":"Wide Sweet Potato Noodles"}, price: 170, note: "おすすめ" },
      { id: "corn-noodle", name: "トウモロコシ麺50g", displayNames: {"zh":"玉米面","ko":"옥수수면","en":"Corn Noodles"}, price: 170 },
      { id: "harusame", name: "春雨50g", displayNames: {"zh":"粉丝","ko":"당면","en":"Glass Noodles"}, price: 140 },
      { id: "sweet-potato-noodle", name: "さつまいも麺50g", displayNames: {"zh":"红薯粉","ko":"고구마당면","en":"Sweet Potato Noodles"}, price: 140 },
      { id: "rice-noodle", name: "ビーフン50g", displayNames: {"zh":"米粉","ko":"쌀국수","en":"Rice Noodles"}, price: 140 },
      { id: "beef-noodle", name: "【もちもちつるん】牛筋麺50g", displayNames: {"zh":"牛筋面","ko":"우근면","en":"Niujin Noodles"}, price: 220 },
      { id: "tteokbokki", name: "トッポッキ50g", displayNames: {"zh":"韩式年糕","ko":"떡볶이떡","en":"Tteokbokki Rice Cakes"}, price: 170 },
      { id: "soybean-sprouts-noodle", name: "【ヘルシー】小大豆もやし50g", displayNames: {"zh":"黄豆芽","ko":"콩나물","en":"Soybean Sprouts"}, price: 140 },
      { id: "wide-sweet-potato-noodle", name: "さつまいも板春雨50g", displayNames: {"zh":"红薯宽粉","ko":"고구마 넓적당면","en":"Wide Sweet Potato Noodles"}, price: 170 },
      { id: "round-yam-sheet", name: "【数量限定】山芋粉皮（丸）50g", displayNames: {"zh":"圆形山药粉皮","ko":"둥근 참마 당면","en":"Round Chinese Yam Starch Sheets"}, price: 140 },
  ...
  },
  {
    ...
    perOptionMax: 50,
    items: [
      { id: "squid-ball", name: "特選イカ団子1個", displayNames: {"zh":"花枝丸","ko":"화지완(오징어 완자)","en":"Cuttlefish Ball"}, price: 220 },
      { id: "pork-ball", name: "特選豚団子1個", displayNames: {"zh":"猪肉贡丸","ko":"돼지고기 공완","en":"Taiwanese Pork Meatball"}, price: 200 },
      { id: "beef-ball", name: "特選牛肉団子1個", displayNames: {"zh":"牛肉贡丸","ko":"소고기 공완","en":"Taiwanese Beef Meatball"}, price: 220 },
      ...
      { id: "tofu-skin", name: "火鍋豆皮", displayNames: {"zh":"火锅豆皮","ko":"훠궈 두부피","en":"Hot Pot Tofu Skin"}, price: 180 },
      { id: "quail-egg", name: "うずらの卵1個", displayNames: {"zh":"鹌鹑蛋","ko":"메추리알","en":"Quail Eggs"}, price: 100 },
      { id: "tofu-knots", name: "結びゆば1個", displayNames: {"zh":"百叶结","ko":"두부 매듭","en":"Tofu Knots"}, price: 150 },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "eringi", name: "エリンギ", displayNames: {"zh":"杏鲍菇","ko":"새송이버섯","en":"King Oyster Mushroom"}, price: 320 },
      { id: "enoki", name: "えのき", displayNames: {"zh":"金针菇","ko":"팽이버섯","en":"Enoki Mushroom"}, price: 240 },
      { id: "okra", name: "オクラ1本", displayNames: {"zh":"秋葵","ko":"오크라","en":"Okra"}, price: 220 },
      { id: "kanikama", name: "カニカマ", displayNames: {"zh":"蟹棒","ko":"게맛살","en":"Imitation Crab Stick"}, price: 270 },
      ...
      { id: "sweet-potato", name: "さつまいも", displayNames: {"zh":"红薯","ko":"고구마","en":"Sweet Potato"}, price: 290 },
      { id: "shimeji", name: "しめじ", displayNames: {"zh":"蟹味菇","ko":"만가닥버섯","en":"Shimeji Mushrooms"}, price: 290 },
      ...
      { id: "menma", name: "【もちもち】穂先メンマ", displayNames: {"zh":"糯米笋","ko":"죽순 멘마","en":"Tender Bamboo Menma"}, price: 240 },
      ...
      { id: "cherry-tomato", name: "国産プチトマト1個", displayNames: {"zh":"国产小番茄","ko":"일본산 방울토마토","en":"Japanese Cherry Tomatoes"}, price: 80 },
      ...
      { id: "soybean-sprouts", name: "【大分県産】小大豆もやし", displayNames: {}, price: 220 },
      { id: "baby-leaf", name: "【栄養】ベビーリーフ", displayNames: {}, price: 220 },
      { id: "ganmodoki", name: "ミニがんも1個", displayNames: {"zh":"迷你炸豆腐饼","ko":"미니 두부튀김","en":"Mini Fried Tofu Fritter"}, price: 80 },
      { id: "aburaage", name: "油あげ", displayNames: {"zh":"油豆腐","ko":"유부","en":"Fried Tofu (Aburaage)"}, price: 150 },
      { id: "shishamo", name: "【ぷちぷち】子持ちししゃも一匹", displayNames: {"zh":"柳叶鱼","ko":"알배기 시샤모","en":"Roe Shishamo Smelt"}, price: 180 },
      { id: "bamboo-shoots", name: "たけのこ", displayNames: {"zh":"竹笋","ko":"죽순","en":"Bamboo Shoots"}, price: 240 },
      { id: "nanohana", name: "菜の花", displayNames: {"zh":"菜心","ko":"유채나물","en":"Rapeseed Greens"}, price: 220 },
      { id: "komatsuna", name: "小松菜", displayNames: {"zh":"小松菜","ko":"고마쓰나","en":"Komatsuna Greens"}, price: 160 },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "squid", name: "イカ🦑 （約50g ）", displayNames: {"zh":"鱿鱼","ko":"오징어","en":"squid"}, price: 320 },
  ...
  },
  {
    ...
    perOptionMax: 10,
    items: [
      { id: "stem-lettuce", name: "山クラゲ🥇", displayNames: {"zh":"贡菜","ko":"궁채","en":"Gongcai (Dried Lettuce Stem)"}, price: 220 },
