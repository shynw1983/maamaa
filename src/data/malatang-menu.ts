...
export const presetSoups: PresetSoup[] = [
  {
    ...
    defaultNoodle: "板春雨",
    note: "国産牛すじ、板春雨、青菜、きのこ、根菜、きくらげ入り。麺を変更した場合、セットの板春雨と入れ替わります。",
  },
  {
    ...
    category: "chef-special",
    defaultNoodle: "板春雨",
    note: "丸ごとカマンベールと定番具材、板春雨入り。麺を変更した場合、セットの板春雨と入れ替わります。",
  },
  {
    ...
    category: "chef-special",
    defaultNoodle: "板春雨",
    note: "厳選した霜降り黒毛和牛と定番具材、板春雨入り。麺を変更した場合、セットの板春雨と入れ替わります。",
  },
  {
    id: "set-beef",
    name: "牛肉マーラータン",
    ...
    defaultNoodle: "板春雨",
    note: "牛肉とおすすめ具材、板春雨が入ったセットです。麺を変更した場合、セットの板春雨と入れ替わります。",
  },
  {
    id: "set-pork",
    name: "【超人気🏮】豚肉マーラータン",
    ...
    category: "recommended-set",
    defaultNoodle: "板春雨",
    note: "豚肉とおすすめ具材、板春雨が入ったセットです。麺を変更した場合、セットの板春雨と入れ替わります。",
  },
  {
    id: "set-lamb",
    ...
    category: "recommended-set",
    defaultNoodle: "板春雨",
    note: "厳選ラム肉とおすすめ具材、板春雨が入ったセットです。麺を変更した場合、セットの板春雨と入れ替わります。",
  },
  {
    id: "set-seafood-trio",
    ...
    category: "recommended-set",
    defaultNoodle: "板春雨",
    note: "大海老を含む3種の海鮮、おすすめ具材、板春雨入り。麺を変更した場合、セットの板春雨と入れ替わります。",
  },
  {
    id: "set-vegetable",
    name: "野菜マーラータン",
    ...
    category: "recommended-set",
    defaultNoodle: "板春雨",
    note: "野菜を中心にしたおすすめ具材と板春雨入り。麺を変更した場合、セットの板春雨と入れ替わります。",
  },
  {
    id: "set-cilantro",
    name: "パクチーマーラータン",
    ...
    category: "recommended-set",
    defaultNoodle: "板春雨",
    note: "パクチーとおすすめ具材、板春雨が入ったセットです。麺を変更した場合、セットの板春雨と入れ替わります。",
  },
  {
    ...
    category: "recommended-set",
    defaultNoodle: "板春雨",
    note: "鶏肉を中心にしたおすすめ具材と板春雨入り。麺を変更した場合、セットの板春雨と入れ替わります。",
  },
];
